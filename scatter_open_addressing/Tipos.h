 ...
 *
 * Descrição: Tipos utilizados pelo programa de dispersão com endereçamento aberto
 *
 ****/
...
typedef struct {
   ...
   /* Tipo de um ponteiro para uma função de */
   /* dispersão com endereçamento aberto     */
